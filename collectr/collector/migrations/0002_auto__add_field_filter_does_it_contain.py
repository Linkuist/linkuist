...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Filter.does_it_contain'
        db.add_column('collector_filter', 'does_it_contain', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Filter.does_it_contain'
        db.delete_column('collector_filter', 'does_it_contain')
