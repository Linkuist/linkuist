...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LinkSum.author'
        db.delete_column('source_linksum', 'author_id')

        # Adding field 'LinkSum.hidden'
        db.add_column('source_linksum', 'hidden', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'LinkSum.author'
        db.add_column('source_linksum', 'author', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source.Author'], null=True, blank=True), keep_default=False)

        # Deleting field 'LinkSum.hidden'
        db.delete_column('source_linksum', 'hidden')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 28, 18, 33, 37, 556802)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 28, 18, 33, 37, 556597)'}),
