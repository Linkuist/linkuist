...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Filter.to_collection'
        db.add_column('source_filter', 'to_collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['source.Collection'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Filter.to_collection'
        db.delete_column('source_filter', 'to_collection_id')
