...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LinkSum.summary'
        db.alter_column('source_linksum', 'summary', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'LinkSum.summary'
        db.alter_column('source_linksum', 'summary', self.gf('django.db.models.fields.TextField')(default=None))
