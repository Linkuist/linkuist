...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Collection.xpath'
        db.delete_column('source_collection', 'xpath')

        # Adding field 'Filter.xpath'
        db.add_column('source_filter', 'xpath', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Collection.xpath'
        db.add_column('source_collection', 'xpath', self.gf('django.db.models.fields.TextField')(default=''), keep_default=False)

        # Deleting field 'Filter.xpath'
        db.delete_column('source_filter', 'xpath')
