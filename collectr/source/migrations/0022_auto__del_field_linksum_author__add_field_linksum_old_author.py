...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'LinkSum.author'
        raise RuntimeError("Cannot reverse this migration. 'LinkSum.author' and its values cannot be restored.")
