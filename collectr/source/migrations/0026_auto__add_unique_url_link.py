...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Url', fields ['link']
        db.create_unique('source_url', ['link'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Url', fields ['link']
        db.delete_unique('source_url', ['link'])
