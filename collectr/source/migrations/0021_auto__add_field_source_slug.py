...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('source_source', 'slug', self.gf('django.db.models.fields.CharField')(default='', unique=True, max_length=32), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.slug'
        db.delete_column('source_source', 'slug')
