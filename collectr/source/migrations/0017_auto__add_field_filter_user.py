...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Filter.user'
        db.add_column('source_filter', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Filter.user'
        db.delete_column('source_filter', 'user_id')
