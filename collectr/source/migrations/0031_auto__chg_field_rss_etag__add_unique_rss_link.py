...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Rss.etag'
        db.alter_column('source_rss', 'etag', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

        # Adding unique constraint on 'Rss', fields ['link']
        db.create_unique('source_rss', ['link'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Rss', fields ['link']
        db.delete_unique('source_rss', ['link'])

        # Changing field 'Rss.etag'
        db.alter_column('source_rss', 'etag', self.gf('django.db.models.fields.CharField')(default=None, max_length=128))
