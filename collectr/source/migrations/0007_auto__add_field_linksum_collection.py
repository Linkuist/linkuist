...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LinkSum.collection'
        db.add_column('source_linksum', 'collection', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['collector.Collection'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LinkSum.collection'
        db.delete_column('source_linksum', 'collection_id')
    ...
    models = {
        ...
        'source.linksum': {
            ...
            'collection': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['collector.Collection']", 'null': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
