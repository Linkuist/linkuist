...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LinkSum.old_author'
        db.delete_column('source_linksum', 'author')


    def backwards(self, orm):
        
        # Adding field 'LinkSum.old_author'
        db.add_column('source_linksum', 'old_author', self.gf('django.db.models.fields.CharField')(default='', max_length=64, db_column='author'), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 28, 17, 42, 52, 708145)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 28, 17, 42, 52, 707934)'}),
